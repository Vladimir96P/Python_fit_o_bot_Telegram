    ...
    if msg.text == "Низкая активность 🐌":
        ...
        with psycopg2.connect(db_URL, sslmode="require") as postgre_con:
            ...
            if sex == 'М':
                ...
                🤔 По моим данным твой текущий и последний записанный вес составляет *{last_weight_str}* кг{backslash}. Рост {backslash}= *{height}* cм{backslash}. Возраст {backslash}= *{age}*{backslash}. *Мужской* пол{backslash}.
