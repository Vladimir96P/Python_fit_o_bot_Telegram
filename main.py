    ...
    if msg.text == "Низкая активность 🐌":
        ...
        with psycopg2.connect(db_URL, sslmode="require") as postgre_con:
            ...
            if sex == 'М':
                ...
                🤔 По моим данным твой текущий и последний записанный вес составляет *{str(last_weight).replace('.', f'{backslash}.')}* кг{backslash}. *Рост_ {backslash}= *{height}* м; *Возраст_ {backslash}= *{age}*; *Пол_: *{sex}*{backslash}.
                ...
                \n★ *{protein_nutrient}* г *белков_;
                \n★ *{carbs_nutrient}* г *углеводов_{backslash}.
                \n★ А также выпивать не меньше, чем *{water_quantity}* л *чистой воды_{backslash}!
                \nИтого твой суммарный рацион за день составит *{target_calories}* *калорий_{backslash}.
                \nДля подсчета и записи рациона тебе пригодятся соответствующие приложения, а также необходимы кухонные весы{backslash}. Подробнее про питание и тренировки узнаешь в *@fit_o_blog* 😎{backslash}!
                ...
                carbs_nutrient = round((0.4 * target_calories) / 4)
                bot.send_message(msg.chat.id, f'''
                🤔 По моим данным твой текущий и последний записанный вес составляет {last_weight} кг. Рост = {height} м; Возраст = {age}; Пол: {sex}.
