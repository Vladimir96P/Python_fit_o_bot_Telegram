    ...
    if msg.text == "Низкая активность 🐌":
        ...
        with psycopg2.connect(db_URL, sslmode="require") as postgre_con:
            ...
            if sex == 'М':
                ...
                🤔 По моим данным твой текущий и последний записанный вес составляет *{str(last_weight).replace('.', '\.')}* кг\. *Рост_ \= *{height}* м; *Возраст_ \= *{age}*; *Пол_: *{sex}*\.
                ...
                \n★ *{carbs_nutrient}* г *углеводов_\.
                \n★ А также выпивать не меньше, чем *{water_quantity}* л *чистой воды_\!
                \nИтого твой суммарный рацион за день составит *{target_calories}* *калорий_\.
                \nДля подсчета и записи будут очень полезны соответствующие приложения, а также кухонные весы\. Подробнее про питание и тренировки узнаешь в *@fit_o_blog* 😎\!
